    ...
    <nav className="   z-40">
      <div className=" container-wrapper mx-auto  flex justify-between items-center  px-8 py-1 ">
        ...
        <div className="hidden md:flex flex-grow justify-center">
          <a href="/" className="text-[#f4dc75] font-bold text-lg px-3 py-2">Home</a>
          <a href="#about" className="text-[#f4dc75] font-bold text-lg px-3 py-2">About</a>
          <a href="#col" className="text-[#f4dc75] font-bold text-lg px-3 py-2">Tokenomics</a>
         
          <a href="#contact" className="text-[#f4dc75] font-bold text-lg px-3 py-2">Contact Us</a>
        </div>
        ...
        <a
                  ...
                  className=" text-xl text-black bg-[#f4dc75] hover:bg-[#1a4093] rounded-full p-2 border-2 border-[#000]  hover:text-[#fff]"
                >
                  <BsTwitterX />
                </a>
